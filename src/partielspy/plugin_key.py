...
class PluginKey:
    ...
    Each :class:`Track <partielspy.track>` class has a plugin key associated with it.
    The plugin key is used to identify the plugin that is associated with the track.
    The get_plugin_list() method of the :class:`Partiels <partielspy.partiels>` class returns\
