...
class Partiels:
    ...
    def createJpegExporter(
        self, width: int = 1000, height: int = 800, groups: bool = False
    ):
    ...
    def createCsvExporter(
        self, nogrids: bool = False, header: bool = False, separator: str = ","
    ):
    ...
    def createSdifExporter(
        self, frame: str = None, matrix: str = None, colname: str = None
    ):
